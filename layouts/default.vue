...
      <header>
        ...
        <div class="sui-navbar"> 
            ...
            <div class="sui-nav pull-right info" v-if="user.name!==undefined"> 
             ...
             <div class="sui-nav pull-right info" v-if="user.name===undefined"> 
                <!-- <router-link to="/login" class="notice">登录</router-link> -->
                <li><a href="login" class="notice">登录</a></li>
             </div>
            </div> 
            </div> 
        </div>
...
      <footer>
        ...
        <div class="wrapper"> 
            ...
            <p>本站由 Geekerstar 提供更新服务</p> 
            </div> 
            </div> 
            <p class="Copyright">Copyright &copy; 2018 猿社区</p> 
            </div> 
        </div> 
        </div> 
      </footer>
